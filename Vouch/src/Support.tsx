  ...
  return (
    <div className="min-h-screen bg-brand-bg text-brand-text font-sans selection:bg-[#872a8c] selection:text-white overflow-x-hidden relative">
      ...
      <div className="container mx-auto px-4 md:px-8 pt-32 pb-20 relative z-10 w-full">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                <div className="order-2 lg:order-1 relative px-4 md:px-0">
                    ...
                    <p className="text-brand-muted text-lg mb-10 leading-relaxed border-l-2 border-brand-text/10 pl-6 text-justify">
                        Temos uma equipe que realiza atendimentos onlines e personalizados para suas garantidoras, com tempo médio de resposta inferior a 5 minutos.
                    </p>
                    <ul className="space-y-4">
                        <li className="group flex items-center gap-4 p-4 rounded-xl bg-brand-text/[0.02] border-0 hover:bg-brand-text/[0.04] transition-all duration-300 cursor-default">
                            ...
                            <span className="text-brand-text font-medium text-lg">Dúvidas simples do dia a dia</span>
                        </li>
                        <li className="group flex items-center gap-4 p-4 rounded-xl bg-brand-text/[0.02] border-0 hover:bg-brand-text/[0.04] transition-all duration-300 cursor-default">
                            <div className="p-2 rounded-full bg-[#38c88a]/10 text-[#38c88a] group-hover:scale-110 group-hover:bg-[#38c88a] group-hover:text-white transition-all duration-300 shadow-sm">
                                <Check size={20} strokeWidth={3} />
                        ...
                        <div className="flex-1 bg-[#0B1120] p-4 space-y-5 overflow-y-auto relative scrollbar-thin">
                            ...
                            <div className="flex justify-end animate-chat-1">
                                <div className="bg-[#872a8c] text-white p-3.5 rounded-2xl rounded-tr-none max-w-[80%] shadow-lg relative group-hover:shadow-[#872a8c]/20 transition-all">
                                    ...
                                    <div className="flex justify-end items-center gap-1 mt-1 opacity-70"><span className="text-[10px]">09:41</span><CheckCircle2 size={12} /></div>
                                </div>
                            </div>
                            <div className="flex justify-start animate-chat-2" style={{ animationDelay: '0.5s' }}>
                                <div className="bg-[#1E293B] text-white p-3.5 rounded-2xl rounded-tl-none max-w-[85%] shadow-lg border border-white/5 relative">
                                    <p className="text-sm leading-relaxed">Olá! Boa tarde Tudo bem ? Consigo te auxiliar sim, qual seria sua dúvida sobre o rateio?</p>
                            ...
                            <div className="flex justify-end animate-chat-1" style={{ animationDelay: '1.0s' }}>
                                <div className="bg-[#872a8c] text-white p-3.5 rounded-2xl rounded-tr-none max-w-[80%] shadow-lg relative group-hover:shadow-[#872a8c]/20 transition-all">
                                    ...
                                    <div className="flex justify-end items-center gap-1 mt-1 opacity-70"><span className="text-[10px]">09:43</span><CheckCircle2 size={12} /></div>
                                </div>
                            </div>
        ...
        {/* --- A TRÍADE DE SUCESSO (ESTRUTURA MODIFICADA APENAS PARA O AVA) --- */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20 items-stretch">
            
         {/* CARD 1 - VOUCH ACADEMY (FULL WIDTH / LARGO) */}
            <div className="lg:col-span-2 group relative bg-brand-bg border border-brand-text/5 rounded-[3rem] p-8 md:p-12 overflow-hidden shadow-2xl transition-all duration-500 hover:border-[#872a8c]/30">
                <div className="absolute inset-0 bg-gradient-to-r from-[#872a8c]/5 via-transparent to-transparent"></div>
                
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-center relative z-10">
                    {/* Texto do AVA */}
                    <div className="lg:col-span-2 space-y-6">
                        <div className="w-14 h-14 rounded-xl bg-[#872a8c]/10 flex items-center justify-center text-[#872a8c] mb-5 shadow-[0_0_15px_rgba(135,42,140,0.15)]">
                            <GraduationCap size={32} />
                        </div>
                        <h3 className="text-3xl font-bold text-brand-text mb-3">Vouch Academy™</h3>
                        <p className="text-brand-muted text-lg leading-relaxed text-justify">
                            Ambiente Virtual de Aprendizagem. Sua equipe aprende a usar a plataforma com trilhas interativas, garantindo domínio total.
                        </p>
                    </div>

{/* Imagem do AVA - LIMPA E ALINHADA À DIREITA */}
{/* Adicionei 'justify-end' para empurrar o conteúdo para a direita */}
<div className="lg:col-span-3 relative flex items-center justify-end">
    <img 
        src="/AVA.png" 
    ...
    />
            ...
            {/* CARD 3 - ACOMPANHAMENTO (Original) */}
            <div className="group relative bg-brand-bg border-0 rounded-[2.5rem] p-8 flex flex-col overflow-hidden shadow-xl h-full">
        ...
        <div className="mb-32 relative">
            <div className="text-center mb-20">
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-brand-text">Da contratação até sua operação estar no ar</h2>
            ...
            <div className="space-y-16 relative z-10">
                <div className="flex flex-col md:flex-row items-center gap-8 group">
                    <div className="w-full md:w-1/2 pl-16 md:pl-0 md:pr-16 md:text-right">
                        <h3 className="text-2xl font-bold text-brand-text group-hover:text-[#38c88a] transition-colors">Passo 1: Start </h3>
                        <p className="text-base text-brand-muted text-justify md:text-right mt-2">Assinatura do contrato.</p>
                    </div>
                    ...
                    <div className="w-full md:w-1/2 pl-16 md:pl-16">
                        <div className="p-6 rounded-2xl bg-brand-text/[0.02] border border-brand-text/5 group-hover:bg-[#38c88a]/[0.05] group-hover:border-[#38c88a]/20 transition-all">
                            <div className="flex items-center gap-4">
                                ...
                                <span className="text-sm font-mono text-[#38c88a]">Inicio do processo</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row items-center gap-8 group">
                    ...
                    <div className="w-full md:w-1/2 pl-16 md:pl-16">
                        <h3 className="text-2xl font-bold text-brand-text group-hover:text-[#872a8c] transition-colors">Passo 2: Migração de Dados</h3>
                ...
                <div className="flex flex-col md:flex-row items-center gap-8 group">
                    <div className="w-full md:w-1/2 pl-16 md:pl-0 md:pr-16 md:text-right">
                        <h3 className="text-2xl font-bold text-brand-text group-hover:text-[#4a90e2] transition-colors">Passo 3: Treinamento</h3>
                 ...
                 <div className="flex flex-col md:flex-row items-center gap-8 group">
                    ...
                    <div className="w-full md:w-1/2 pl-16 md:pl-16">
                        <h3 className="text-2xl font-bold text-brand-text group-hover:text-[#f2c94c] transition-colors">Passo Final: Operando 100% !</h3>
        ...
        <div className="mt-32 text-center">
             ...
             <button 
               ...
               className="px-12 py-5 bg-[#872a8c] hover:bg-[#b77fba] text-white font-bold rounded-2xl transition-all shadow-lg hover:-translate-y-1 inline-flex items-center gap-3 text-lg">
